...
//       //before annotation was not working so just calling the driver here
	...
	public void user_enter_customer_info() throws InterruptedException {
		...
		AdCuP.setFirstName("Victoria");
		AdCuP.setLastName("Terces");
//        AdCuP.calendar();
//        AdCuP.selectingdate();
		AdCuP.manualdate();
	...
	public void user_should_found_email_in_the_search_table() throws InterruptedException {
		...
		WebElement mail= driver.findElement(By.xpath("//table[@class='table table-bordered table-hover table-striped dataTable no-footer']//th[text()='Email']"));
        Executor(mail);
        TimeUnit.SECONDS.sleep(5);
		boolean status = searchcustomer.searchCustomerByEmail(email);
...
//----------------------Entering First and Last Name--------
	...
	public void user_should_found_name_in_the_search_table() throws InterruptedException {
		...
		WebElement ele = driver.findElement(By.xpath("//table[@class='table table-bordered table-hover table-striped dataTable no-footer']//th[text()='Name']"));
